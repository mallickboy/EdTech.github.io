...
CREATE TABLE `user_access` (
  ...
  CONSTRAINT `user_access_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_profile` (`id`),
  CONSTRAINT `user_access_ibfk_2` FOREIGN KEY (`course_id`) REFERENCES `current_courses` (`course_id`)
...
INSERT INTO `user_access` VALUES (1,1,3),(2,9,1);
